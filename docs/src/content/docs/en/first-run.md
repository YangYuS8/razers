...
1. Follow [installation](/razers/en/getting-started/) and open `razers`.
...
4. If the list is empty, read the connection hints in
   [troubleshooting](/razers/en/troubleshooting/). Do not install a kernel driver,
...
RazeRS hardware support. Next, learn to [contribute evidence](/razers/en/contribute-evidence/).
